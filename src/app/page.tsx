                ...
                <div className="mt-5  flex flex-col justify-center items-start max-w-lg">
                  ...
                  soy <span className="text-teal-300 ">Santiago</span>
                    ...
                    <div className="flex gap-2">
                        ...
                        <a className="flex" href="https://co.linkedin.com/in/maesedev" >
                        ...
                        <a className="flex" href="mailto:santiagocolombiahoy@gmail.com">
                        ...
                        <a className="flex" href="https://github.com/maesedev" >
