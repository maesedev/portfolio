        ...
        <nav className="z-50 fixed w-screen backdrop-blur-sm border-gray-200  shadow-sm animate-fade-down animate-once animate-duration-1000 animate-delay-1000 animate-ease-out">
            <div className=" max-w-screen-xl flex  items-center justify-between mx-auto p-4">
                ...
                <button onClick={() => { setOpenNav(!openNav) }} data-collapse-toggle="navbar-dropdown" type="button" className={"z-50 inline-flex items-center p-2 ml-3 text-base text-gray-200 rounded-lg md:hidden transition-transform    " + (openNav ? "  rotate-90  " : "") + " focus:outline-none  bg-gray-700 dark:focus:ring-gray-600"} aria-controls="navbar-dropdown" aria-expanded="false">
                    ...
                    <Bars3Icon className={"h-10 w-10 " + (openNav ? " fill-pink-400 " : "fill-white ")} />
                </button>

                <div className={"fixed md:static  w-96  top-0 left-[ calc( 100vw - 12rem) ] md:left-0 md:w-full md:block  " + (openNav ? "" : "hidden")} id="navbar-dropdown">
                    <ul className="pt-20  flex flex-col font-medium  md:justify-center p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:flex-row md:space-x-8 md:mt-0 md:border-0 md:bg-transparent dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
                        <li>
                            <a href="/#about" className="block py-2 pl-3 pr-4 text-white bg-blue-700 rounded md:bg-transparent  md:p-0  " aria-current="page">
                                Sobre mi
                            </a>
                        </li>
                        <li>
                            <a href="#" className="block py-2 pl-3 pr-4 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0  md:text-yellow-400 md:p-0 dark:text-white md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent">
                                Proyectos
                            </a>
                        </li>
                        <li>
                            <a href="/cv" className="block py-2 pl-3 pr-4 text-gray-900 md:text-white rounded md:bg-transparent  md:p-0  dark:text-white ">
                                CV
                            </a>
                        </li>
                        {/* 
                ...
                <a href="/#Form" type="button" className="hidden md:block text-white bg-gradient-to-br from-purple-600 to-blue-500 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center">
                    Contactame
                </a>
            </div>
        </nav>
